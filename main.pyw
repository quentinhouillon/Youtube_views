...
#BUTTON
save_url = Button(footer, text="save url", bg="blue", fg=color2, padx=15,
                  command=save)

find_url = Button(footer, text="find url", bg="brown", fg=color2, padx=15,
                  command=find)

enter = Button(footer, text="enter", bg="green", fg=color2, padx=15,
               command=run)
